...
export function saveSignatureParamsInClientData(context, noteDesc, noteId) {
    ...
    return libDigSig.readConfiguration(context).then(config =>{
        let tableFields = config.ObjectConfig.TableFields;
        ...
        clientData.SigningApplication = config.ObjectConfig.Application;//'EAM_OP';
        clientData.SigningApplicationSubObject = config.ObjectConfig.Object;//'EAM_OB';
