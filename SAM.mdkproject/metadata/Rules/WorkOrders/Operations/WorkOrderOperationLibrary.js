...
export class OperationConstants {
    ...
    static OperationListQueryOptions(context) {
        libCommon.setStateVariable(context, 'CustomListFilter', '');
        return ''
        + '$expand=WOObjectList_Nav,Tools,OperationMobileStatus_Nav,OperationLongText,WOHeader,WOHeader/OrderMobileStatus_Nav,WOHeader/UserTimeEntry_Nav,UserTimeEntry_Nav,WOHeader/WOPriority,Employee_Nav'
