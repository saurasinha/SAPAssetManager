...
export default function PartCreateOnSuccess(pageProxy) {
    ...
    if (note) {
        ...
        pageProxy.executeAction('/SAPAssetManager/Actions/Notes/Create/NotesCreateOnParts.action');
    } else {
        pageProxy.executeAction('/SAPAssetManager/Actions/Page/ClosePageToastCreate.action');
    }
