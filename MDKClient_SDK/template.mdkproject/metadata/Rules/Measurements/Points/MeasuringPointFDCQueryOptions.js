                ...
                for (let op in results.Operations) {
                    ...
                    if (results.Operations[op].EquipmentOperation) {
                        for (let pt in results.Operations[op].EquipmentOperation.MeasuringPoints) {
                            ...
                            MeasuringPointData[results.Operations[op].EquipmentOperation.MeasuringPoints[pt].Point] = {'OrderId' : context.binding.ObjectKey, 'Operation': results.Operations[op].ObjectKey, 'OperationNo': tempOperation, 'OperationShortText': results.Operations[op].OperationShortText, 'Operations/Tools/PRTCategory':results.Operations[op].Tools.PRTCategory};
                        }
                    }
                    // Operation FLOC?
                        ...
                        for (let obj in results.Operations[op].WOObjectList_Nav) {
                            ...
                            if (results.Operations[op].WOObjectList_Nav[obj].Equipment_Nav) {
                                for (var _pt6 in results.Operations[op].WOObjectList_Nav[obj].Equipment_Nav.MeasuringPoints) {
                                  ...
                                  MeasuringPointData[results.Operations[op].WOObjectList_Nav[obj].Equipment_Nav.MeasuringPoints[_pt6].Point] = { 'OrderId': context.binding.ObjectKey, 'Operation': results.Operations[op].ObjectKey, 'OperationNo': tempOperation, 'OperationShortText': results.Operations[op].OperationShortText, 'Operations/Tools/PRTCategory': results.Operations[op].Tools.PRTCategory };
                                }
                            }
                            // objectlist FLOC
                            if (results.Operations[op].WOObjectList_Nav[obj].FuncLoc_Nav) {
                                for (var _pt7 in results.Operations[op].WOObjectList_Nav[obj].FuncLoc_Nav.MeasuringPoints) {
                                    ...
                                    MeasuringPointData[results.Operations[op].WOObjectList_Nav[obj].FuncLoc_Nav.MeasuringPoints[_pt7].Point] = { 'OrderId': context.binding.ObjectKey, 'Operation': results.Operations[op].ObjectKey, 'OperationNo': tempOperation, 'OperationShortText': results.Operations[op].OperationShortText, 'Operations/Tools/PRTCategory': results.Operations[op].Tools.PRTCategory };
                                }
                            }
                        }
                    }
