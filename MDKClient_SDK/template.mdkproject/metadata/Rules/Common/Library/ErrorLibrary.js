...
export default class {
    ...
    static saveError(context) {
        this.setErrorName(context, this.getErrorKey(context));
        this.saveErrorMessage(context, this.getErrorKey(context));
    }
    ...
    static saveErrorMessage(context, key) {
        try {
            appSettings.remove(context, key+'message');
            if (!libVal.evalIsEmpty(context.Error)) {
                appSettings.setString(context, key+'message', context.Error.message);
            } else {
