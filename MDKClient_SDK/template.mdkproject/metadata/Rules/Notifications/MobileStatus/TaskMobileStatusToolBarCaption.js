...
export default function TaskMobileStatusToolBarCaption(context) {
    ...
    let notifTaskMobileStatus = libMobile.getMobileStatus(context.binding);
    let notifMobileStatus = libMobile.getMobileStatus(context.binding.Notification || context.binding.Item.Notification);
