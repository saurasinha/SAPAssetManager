...
export default class {
        ...
        return this.showNotificationCompleteWarningMessage(context).then(
            proceed => {
                if (proceed) {
                    ...
                    return this.executeCompletionStepsAfterDigitalSignature(context);
                } else {
    ...
    static cancelDigitalSignature(context) {
    ...
    static createDigitalSignatureAndCompleteNotification(context) {
