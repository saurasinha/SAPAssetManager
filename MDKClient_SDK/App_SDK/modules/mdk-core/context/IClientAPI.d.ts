 ...
 */
export interface IControlProxy extends IClientAPI {
  /**
 ...
 * application specific customizations.
 */
export interface IControlContainerProxy extends IClientAPI {
  /**
 ...
 */
export interface IFormCellProxy extends IControlProxy {
  /**
 ...
 * for application specific customizations.
 */
export interface IFormCellTargetProxy extends ITargetProxy {
  /**
   * @return {string}
   */
...
export interface IListPickerFormCellTargetProxy extends IFormCellTargetProxy {
  /**
   * @return {any}
   */
  getObjectCell(): any;
 ...
 */
export interface IPageProxy extends IControlContainerProxy {
  /**
 ...
 * for application specific customizations.
 */
export interface ISectionedTableProxy extends IControlProxy {
 ...
 * for application specific customizations.
 */
export interface IBindableSectionProxy extends ISectionProxy {
   /**
...
*/
export interface ISelectableSectionProxy extends IBindableSectionProxy {
  /**
 ...
 * 
 */
export interface ILinkSpecifierProxy {
  /**
 ...
 * In addition it provides access to the IControlProxy interface.
 */
export interface IToolbarProxy extends IControlProxy {
  /**
   * This method returns the top-level controls for this container
   * 
   * @return {IControlProxy[]} The controls for this container 
 ...
 * for application specific customizations.
 */
export interface ITabControlProxy extends IControlProxy {
  /**
 ...
 * In addition it provides access to the IControlProxy interface.
 */
export interface ITabItemProxy extends IControlProxy {
  /**
   * Set item caption
   */
 ...
 * In addition it provides access to the IControlProxy interface.
 */
export interface ISideDrawerControlProxy extends IControlProxy {
  /**
 ...
 */
export interface ISideDrawerMenuItemProxy extends IClientAPI {
 ...
 */
export interface IODataProviderProxy {
  /**
 ...
 */
export interface IOfflineODataProviderProxy extends IODataProviderProxy {
  /**
 ...
 */
export interface IOfflineODataParametersProxy {
  /**
