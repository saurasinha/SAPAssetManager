      ...
      },
      {
        ...
        optionList: [
          ...
          },
          {
            ...
            description: 'Space-delimited list of NativeScript modules to be excluded from the bundle. Use this option for dependencies you expect to be in the environment when the application is built.  If not specified, the values "tns-core-modules/file-system" and "tns-core-modules/ui/dialogs" are automatically added.'
          },
          {
