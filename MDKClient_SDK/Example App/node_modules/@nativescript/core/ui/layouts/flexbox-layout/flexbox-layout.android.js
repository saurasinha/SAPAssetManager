...
var FlexboxLayout = (function (_super) {
    ...
    FlexboxLayout.prototype._setChildMinWidthNative = function (child, value) {
        ...
        if (lp instanceof widgetLayoutParams) {
            lp.minWidth = flexbox_layout_common_1.Length.toDevicePixels(value, 0);
            nativeView.setLayoutParams(lp);
        }
    };
    FlexboxLayout.prototype._setChildMinHeightNative = function (child, value) {
        if (!child._ignoreFlexMinWidthHeightReset) {
        ...
        var lp = nativeView.getLayoutParams();
        if (lp instanceof widgetLayoutParams) {
            lp.minHeight = flexbox_layout_common_1.Length.toDevicePixels(value, 0);
            nativeView.setLayoutParams(lp);
        }
    };
