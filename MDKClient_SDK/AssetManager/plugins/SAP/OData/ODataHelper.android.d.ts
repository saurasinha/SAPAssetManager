export declare class ODataHelper {
    ...
    static dataListValueToJson(dataListValue: any, dataContext: any): string;
    ...
    static complexValueToJson(complexValue: any, dataContext: any): string;
    static partnerPropertyFromEntity(property: any, entity: any): any;
    ...
    static getRequestOptions(requestOptions: any, dataService: any): any;
