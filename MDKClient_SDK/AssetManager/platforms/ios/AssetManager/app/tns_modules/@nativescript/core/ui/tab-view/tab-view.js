...
var UITabBarControllerImpl;
var UITabBarControllerDelegateImpl;
var UINavigationControllerDelegateImpl;
var setupControllers = function () {
    if (typeof UITabBarControllerImpl === 'undefined') {
        var UITabBarControllerClass = (function (_super) {
        ...
        var UITabBarControllerDelegateClass = (function (_super) {
        ...
        var UINavigationControllerDelegateClass = (function (_super) {
...
var TabView = (function (_super) {
    ...
    TabView.prototype._getIcon = function (iconSource) {
        ...
        if (!image) {
            var is = image_source_1.ImageSource.fromFileOrResourceSync(iconSource);
            if (is && is.ios) {
...
function getTitleAttributesForStates(tabView) {
    ...
    var font = (tabView.style.fontInternal || font_1.Font.default).getUIFont(UIFont.systemFontOfSize(tabItemFontSize));
