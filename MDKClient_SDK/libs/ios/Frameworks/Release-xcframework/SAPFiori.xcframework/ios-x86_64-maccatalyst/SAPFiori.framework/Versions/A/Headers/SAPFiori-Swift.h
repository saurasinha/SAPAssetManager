...
#ifndef SAPFIORI_SWIFT_H
#define SAPFIORI_SWIFT_H
...
/// TWO D mode scans Aztec, Data Matrix, PDF417, and QR codes.
  FUIBarcodeScanModeTwo_d = 3,
...
///   </li>
///   <li>
///     Call setTextColor(_:for:) to configure tint color for disabled, normal, highlighted <code>UIControlState</code> of the KPIView and caption text.
///   </li>
///   <li>
///     disabled: Color to be used when control is disabled.
///   </li>
...
///
/// \endcode<h2>Theming</h2>
/// Supported <code>KPIProgressView</code> class paths:
/// \code
///  fdlFUIKPIProgressView {}
///  fdlFUIKPIProgressView_captionLabel {}
///
/// \endcodeSupported <code>KPIProgressView</code> attributes:
/// \code
///  tint-color (Color)
...
///
/// \endcode<h2>Theming</h2>
/// Supported <code>KPIView</code> class paths:
/// \code
///  fdlFUIKPIView {}
///  fdlFUIKPIView_textView {}
///  fdlFUIKPIView_captionLabel {}
///
/// \endcodeSupported <code>KPIView</code> attributes:
/// \code
///  tint-color (Color)
///  tint-color-disabled (Color)
...
/// The following properties needs to be set Before the navigation controller presents this <code>FUIMultiUserPasscodeController</code>:
/// <ul>
///   <li>
///     <code>logoImageView.image</code>
///   </li>
///   <li>
///     <code>logoImageViewSize</code>
///   </li>
///   <li>
///     <code>titleLabel.text</code>
///   </li>
...
///         passcodeController.loadViewIfNeeded()
///
...
///
/// \endcode<h2>Theming</h2>
/// Supported fixed font <code>UILabel</code> class paths:
/// \code
...
///
/// \endcodeSupported fixed font <code>UILabel</code> properties:
/// \code
/// font-size: (Size)
/// font-name: (Font Name)
/// font-color: (Color)
///
/// \endcodeSupported <code>UITextField</code> class paths:
/// \code
/// fdlFUIMultiUserPasscodeController_passcodeInputField
///
/// \endcodeSupported <code>UITextField</code> properties:
/// \code
/// border-color: (Color)
/// border-width: (Width)
...
/// font-color { -disabled }: (Color)
///
/// \endcodeSupported text input field <code>ClearButton</code> class paths:
/// \code
/// fdlFUIMultiUserPasscodeController_clearButton
///
/// \endcodeSupported text input field <code>ClearButton</code> properties:
/// \code
/// image: (Image Name)
/// tint-color: (Color)
///
/// \endcodeSupported <code>UIBarButtonItem</code> class paths:
/// \code
...
///
/// \endcodeSupported <code>ImagePlaceholder</code> class paths:
/// \code
/// fdlFUIMultiUserPasscodeController_userImagePlaceholder
/// fdlFUIMultiUserPasscodeControllerUserCell_imagePlaceholder
///
/// \endcodeSupported <code>ImagePlaceholder</code> properties:
/// \code
/// font-size: (Size)
/// font-name: (Font Name)
/// font-color: (Color)
///
/// \endcodeSupported <code>ImagePlaceholderView</code> class paths:
/// \code
/// fdlFUIMultiUserPasscodeController_userImagePlaceholderView
/// fdlFUIMultiUserPasscodeControllerUserCell_imagePlaceholderView
///
/// \endcodeSupported <code>ImagePlaceholderView</code> properties:
/// \code
/// background-color: (Color)
///
/// \endcodeSupported dynamic font <code>UILabel</code> class paths:
/// \code
...
///
/// \endcodeSupported dynamic font <code>UILabel</code> properties:
/// \code
/// font-style: (Font Style)
/// font-color: (Color)
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori30FUIMultiUserPasscodeController")
@interface FUIMultiUserPasscodeController : FUIPasscodeController
/// :nodoc:
- (void)viewDidLoad;
/// :nodoc:
- (void)viewWillAppear:(BOOL)animated;
...
@interface FUIMultiUserPasscodeController (SWIFT_EXTENSION(SAPFiori)) <FUIListPickerDataSource>
/// :nodoc:
- (NSInteger)numberOfRowsIn:(UITableView * _Nonnull)listPickerTableView SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (UITableViewCell * _Nonnull)listPickerTableView:(UITableView * _Nonnull)tableView cellForRowAt:(NSInteger)index isFiltered:(BOOL)isFiltered SWIFT_WARN_UNUSED_RESULT;
...
@interface FUIMultiUserPasscodeController (SWIFT_EXTENSION(SAPFiori)) <UITextFieldDelegate>
/// :nodoc:
...
@interface FUIMultiUserPasscodeController (SWIFT_EXTENSION(SAPFiori)) <FUIListPickerSearchResultsUpdating>
/// :nodoc:
- (void)listPicker:(id <FUIListPicker> _Nonnull)listPicker updateSearchResults:(NSString * _Nonnull)forSearchString;
/// :nodoc:
- (BOOL)listPicker:(id <FUIListPicker> _Nonnull)listPicker filteredDataSourceContainsItemAt:(NSInteger)unfilteredIndex SWIFT_WARN_UNUSED_RESULT;
...
/// \endcode
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
- (nonnull instancetype)initWithNavigationBarClass:(Class _Nullable)navigationBarClass toolbarClass:(Class _Nullable)toolbarClass OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(maccatalyst,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=5.0);
...
@interface FUIOnboardingScanViewController (SWIFT_EXTENSION(SAPFiori)) <PHPhotoLibraryChangeObserver>
